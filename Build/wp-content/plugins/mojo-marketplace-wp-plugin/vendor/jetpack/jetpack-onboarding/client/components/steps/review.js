	...
	render: function() {
		...
		return (
			React.createElement(WelcomeSection, {id: "welcome__review"}, 
				React.createElement("div", {className: "welcome__dismiss"}, React.createElement("a", {href: "#", onClick:  this.handleDismiss}, React.createElement(Dashicon, {name: "dismiss"}), " Dismiss")), 
				...
				React.createElement("div", {className: "welcome__review-cols"}, 
					React.createElement("div", {className: "welcome__review-col"}, 
						React.createElement("ul", {className: "welcome__review-list"}, 
							React.createElement("li", null, React.createElement(Dashicon, {name: "yes"}), " Title and description ", React.createElement("a", {href: "#", onClick:  this.handleSkipTo( Paths.SITE_TITLE_STEP_SLUG) }, "(edit)")), 
							React.createElement("li", null, React.createElement(Dashicon, {name: "yes"}), " Homepage layout ", React.createElement("a", {href: "#", onClick:  this.handleSkipTo( Paths.IS_BLOG_STEP_SLUG) }, "(edit)"), 
							...
							React.createElement("li", null, React.createElement(Dashicon, {name: "yes"}), 
							 this.state.isJPConnected ?
								...
								React.createElement("a", {href: "#", onClick:  this.handleSkipTo( Paths.JETPACK_MODULES_STEP_SLUG) }, "Connect Jetpack: "), 
					...
					React.createElement("div", {className: "welcome__review-col welcome__review-themes"}, 
						...
						React.createElement("p", null, React.createElement(Button, {href:  JPS.steps.advanced_settings.customize_url, primary: true}, "Choose a Theme"))
					)
				)
			)
		);
